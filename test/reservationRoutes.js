...
describe('Reservation', () => {
  ...
  // });
  //
  // describe('/GET available by date', () => {
  //   it('should return the rooms that available between dates', (done) => {});
  //   it("should return 'no available rooms' if no rooms available", (done) => {})
  // });
